<?php 
  ...
  if(isset($_SESSION['isLoggedIn']) && $_SESSION['isLoggedIn'] ==='yes' && $_SESSION['user_type'] === 'admin'):
?>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="../details/details.php?id=<?php echo $user[$primary_key];?>&table=<?php echo $table;?>"><button type="button" class="btn btn-primary">View Profile</button></a></td>
