...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="../teacher_index.php" class="logo">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview menu-open">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="../table/table.php?table=teacher"><i class="fa fa-circle-o"></i>Teachers</a></li>
            <li><a href="../tables/table.php?table=student"><i class="fa fa-circle-o"></i>Students</a></li>
            <li><a href="../tables/table.php?table=parent"><i class="fa fa-circle-o"></i>Parents</a></li>
            <li><a href="../tables/tables/table.php?table=classroom"><i class="fa fa-circle-o"></i>Classrooms</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="../tables/student.php">Student Data</a></li>
        ...
        <div class="col-md-8">
          ...
          <div class="box box-primary">
            ...
            <form action="#" role="form" method="post">
              <div class="box-body">
                <h4><?php echo "<b>Parent ID :  </b>".$user['parent_id'];?></h4>
                <h4><?php echo "<b>Parent's Name :  </b>".$user['fname']." ".$user['lname'];?></h4>
                <h4><?php echo "<b>Phone :  </b>".$user['phone'];?></h4>
                <h4><?php echo "<b>Mobile :  </b>".$user['mobile'];?></h4>

                <div class="form-group has-feedback"">
                  <label for="exampleInputReport">Report</label>
                  <textarea type="textarea" class="form-control" id="exampleInputReport" placeholder="Enter Your Report Here" name="report"></textarea>
                  <span class="glyphicon glyphicon-file form-control-feedback"></span>
                </div>
                <h4><?php echo "<b>Send Report to :  </b>".$user['email'];?></h4>
                <?php 
                  endwhile;
                  };
                ?>
