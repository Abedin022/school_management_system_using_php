  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="../tables/admin.php">Admins</a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <div class="box box-primary">
            ...
            <form action="delete.php?table=<?php echo $table;?>" role="form" method="post">
              ...
              <div class="form-group has-feedback"">
                <label for="exampleInputID">Enter ID</label>
                <input type="text" class="form-control" id="exampleInputID" placeholder="Enter <?php echo $table; ?> ID" name="id">
                <span class="glyphicon glyphicon-user form-control-feedback"></span>
              </div>
